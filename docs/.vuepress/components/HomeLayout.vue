<template>
  <div class="index">
    ...
    <div class="bottom">
      <div class="list" v-for="item in pageList" :key="item.key">
...
export default {
  data() {
    return {
      pageList: [
        { key: 1, title: 'React 自定义ModalForm组件', path: '/handbook/react/ModalFormItem.html', date: '2022-10-13', author: '陈佳鑫', explain: '避免频繁使用modal框新建简单表单' },
        ...
        { key: 10, title: 'React 图片查看器', path: '/handbook/react/ImgCheck.html', date: '2023-5-04', author: '陈佳鑫', explain: '本组件使用forwardRef编写，可在父组件通过ref直接操作，减少了父子组件通信事件，使组件更加便利' },
      ]
    }
  }
}
