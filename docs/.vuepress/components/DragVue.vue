...
import Product from './DragComponents/View/Product'
import Images from './DragComponents/View/Images'
import Banner from './DragComponents/View/Banner'
import EditForm from './DragComponents/Edit/index'
